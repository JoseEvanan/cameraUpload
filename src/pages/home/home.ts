...
public uploadImage() {
  ...
  /*cloudinary.config({
  cloud_name: 'gento',
  api_key: '237728889441848',
  api_secret: 'I8flkK2HkYES3E-c-RRa28nowg0'
})*/
  var url = "http://51.141.167.97:8000/save_image/"
  console.log(this.lastImage)
  //cloudinary.uploader.upload(this.lastImage, (result) => {
  //  console.log(result)
  //})
